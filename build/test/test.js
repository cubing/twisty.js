"use strict";
// Hacky, yet effective.
function twistyTest(description, condition) {
...
// );
function positionEqual(puz, c, ts, expected) {
    try {
...
(function TestCursorValues() {
    ...
    var a = new Alg.Sequence([
        new Alg.Conjugate(new Alg.BlockMove("R", 1), new Alg.BlockMove("U", 2), 1),
        new Alg.BlockMove("U", -1),
        new Alg.Conjugate(new Alg.BlockMove("R", 1), new Alg.BlockMove("U", -1), 1)
    ]);
    var c = new Twisty.Cursor(a, puz);
