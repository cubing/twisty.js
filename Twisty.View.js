...
console.log(s);
switch (s) {
  case "U": m1.makeRotationX(-Math.PI/2); break;
  case "L": m1.makeRotationY(-Math.PI/2); break;
  case "F": m1.makeRotationZ(0); break;
  case "R": m1.makeRotationY(Math.PI/2); break;
  case "B": m1.makeRotationY(Math.PI); break;
  case "D": m1.makeRotationX(Math.PI/2); break;
}
